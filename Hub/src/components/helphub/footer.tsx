  ...
  return (
    <footer className="bg-slate-900 dark:bg-slate-950 text-slate-300 py-12 sm:py-16">
      <div className={responsive.container}>
        <div className={cn(responsive.gridCols3, "gap-12 lg:gap-8")}>
          {/* Brand & Info */}
        ...
        <div className={cn("mt-8 pt-8 border-t border-slate-800 justify-between items-center gap-4", responsive.stackToRowLg)}>
